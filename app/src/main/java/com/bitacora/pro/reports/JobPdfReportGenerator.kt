...
object JobPdfReportGenerator {
    ...
    private fun drawAgendaSection(canvas: Canvas, job: JobFile, startY: Int): Int {
        ...
        // Section header
        canvas.drawText("Agenda (${job.agendaItems.size})", MARGIN.toFloat(), yPos.toFloat(), headerPaint)
        yPos += 18
    ...
    private fun drawFooter(canvas: Canvas, yPos: Int) {
        ...
        canvas.drawText("Generated by Bitacora Pro v0.5.1 - $timestamp", MARGIN.toFloat(), yPos.toFloat(), footerPaint)
    }
